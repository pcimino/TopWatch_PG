...
antiClockwise: !0,
renderSelf: function(e) {
e.beginPath(), e.lineCap = this.lineCap, e.lineWidth = this.lineWidth, e.antiClockwise = this.antiClockwise;
var t = this.startAngle, n = this.endAngle;
this.useDegrees && (t = this.startAngle * Math.PI / 180, n = this.endAngle * Math.PI / 180), e.arc(this.x, this.y, this.radius, t, n, this.antiClockwise), this.draw(e);
}
});
...
color: "",
renderSelf: function(e) {
e.beginPath(), e.lineWidth = this.lineWidth, e.lineCap = this.lineCap, e.moveTo(this.startPoint.x, this.startPoint.y), e.lineTo(this.endPoint.x, this.endPoint.y), this.draw(e);
}
});
...
color: "",
renderSelf: function(e) {
e.beginPath(), e.lineWidth = this.lineWidth, e.lineCap = this.lineCap;
var t = this.angle;
this.useDegrees && (t = this.angle * Math.PI / 180), this.antiClockwise && (t = 2 * Math.PI - t);
var n = Math.tan(t);
n > 9e10 && (n = 9e10);
var r = this.startPoint.y - n * this.startPoint.x, i = Math.cos(t) / Math.abs(Math.cos(t)), s = this.startPoint.x + this.endDistance / (i * Math.sqrt(1 + Math.pow(n, 2))), o = n * s + r, u = this.startPoint.x, a = this.startPoint.y;
this.startDistance > 0 && (u = this.startPoint.x + this.startDistance / (i * Math.sqrt(1 + Math.pow(n, 2))), a = n * u + r), e.moveTo(u, a), e.lineTo(s, o), this.draw(e);
}
});
...
fillFlag: !0,
renderSelf: function(e) {
e.beginPath(), e.lineWidth = this.lineWidth, e.lineCap = this.lineCap, e.moveTo(this.xPoints[0], this.yPoints[0]);
var t = 1;
for (t = 1; t < this.xPoints.length; t++) e.lineTo(this.xPoints[t], this.yPoints[t]);
this.closePathFlag && (e.closePath(), this.fillFlag && e.fill()), this.draw(e);
}
});
...
bezierFlag: !1,
renderSelf: function(e) {
e.beginPath(), e.strokeStyle = this.outlineColor, e.strokeWidth = this.lineWidth, e.lineWidth = this.lineWidth, e.lineCap = this.lineCap, e.color = this.color, e.outlineColor = this.outlineColor, e.moveTo(this.xPoints[0], this.yPoints[0]);
var t = 1, n = 2;
this.bezierFlag && (n = 3);
var r = this.xPoints.length;
for (t = 1; t < r - n; t += n) this.bezierFlag ? e.bezierCurveTo(this.xPoints[t], this.yPoints[t], this.xPoints[t + 1], this.yPoints[t + 1], this.xPoints[t + 2], this.yPoints[t + 2]) : e.quadraticCurveTo(this.xPoints[t], this.yPoints[t], this.xPoints[t + 1], this.yPoints[t + 1]);
var i = r - t;
i == 3 ? e.quadraticCurveTo(this.xPoints[t], this.yPoints[t], this.xPoints[t + 1], this.yPoints[t + 1]) : i == 2 && e.lineTo(this.xPoints[t], this.yPoints[t]), this.closePathFlag && (e.closePath(), this.fillFlag && e.fill()), this.stroke(e);
}
});

// TopWatch.js

var dialRef = {}, topWatchRef = {}, dialLabel = "", watchLabel = "";
...
name: "message",
style: "font-size: 26px; padding: 6px; text-align: center;color:black;",
content: "Enyo 2 Demonstration App"
}, {
kind: "onyx.Button",
...
var n = t.index;
if (n < this.splitTimeData.length) {
if (n < 0) return !1;
var r = this.splitTimeData[n];
return r.id.length > 0 ? this.$[e.item].setContent(r.id + ": " + r.value) : this.$[e.item].setContent(r.value), !0;
}
},
...
window.open("mailto:Support@TransLunarDesigns.com?subject=Question/Suggestion"), this.$.popupHelp.hide();
},
...
pop: function(e) {
this.popMessage(e.message);
},
popMessage: function(e) {
this.$.HelpPopup.show(), this.$.HelpPopup.setMessage(e);
},
padStr: function(e, t, n) {
var r = t + e;
return r.substring(e.length - n);
},
openBlog: function() {
...
this.inherited(arguments), this.messageChanged();
},
messageChanged: function() {
this.$.message && this.$.message.setContent(this.message);
},
getValue: function() {
...
rendered: function() {
this.inherited(arguments), dialRef = this, this.setupAnimation(), window.addEventListener("devicemotion", function(e) {}, !0), window.addEventListener("deviceorientation", dialRef.handleRotateCanvas.bind(dialRef), !0), TimeDelay.monitorFlag = function() {
var e = (new Date).getTime() - dialRef.startTime;
dialRef.milliSec = e % 1e3, dialRef.second = parseInt(e / 1e3) % 60, dialRef.minute = parseInt(e / 6e4) % 60, dialRef.hour = parseInt(e / 36e5) % 12, dialRef.displayTime(), TimeDelay.runFlag && setTimeout(function() {
...
var t = !1, n = 0;
n = e.beta, n > 45 || n < -45 ? dialRef.g_beta != 90 && (dialRef.g_beta = 90, t = !0) : dialRef.g_beta != 0 && (dialRef.g_beta = 0, t = !0), t && (dialRef.g_change = 0);
},
destroy: function() {
...
drawIndicator: function(e, t, n, r, i, s, o, u) {
...
var a = 360 / s;
for (var f = 0; f <= 360; f += a) dialRef.$.watchFace.createComponent({
...
loop: function() {
dialRef.g_change < 6 && 1 == dialRef.timerRunning && (dialRef.setupCanvasSize(), dialRef.g_change++);
if (!dialRef.firstTime && 0 == dialRef.timerRunning) {
this.start = Date.now(), this.cancel = enyo.requestAnimationFrame(enyo.bind(this, "loop"));
return;
}
...
drawTimerHand: function(e, t, n, r, i, s, o) {
...
startTimer: function() {
dialRef.timerRunning = !0, dialRef.hour = 0, dialRef.minute = 0, dialRef.second = 0, dialRef.milliSec = 0, dialRef.g_timeStr = "00:00:00.000", dialRef.displayTime(), dialRef.displaySplitTime(), TimeDelay.runFlag = !0, dialRef.startTime = (new Date).getTime(), TimeDelay.monitorFlag();
},
splitTimer: function() {
if (TimeDelay.runFlag) {
dialRef.g_timeStr = dialRef.timeString(), dialRef.displaySplitTime();
var e = topWatchRef.getNextId();
topWatchRef.addSplit({
id: " " + e,
value: dialRef.g_timeStr
});
} else {
...
stopTimer: function() {
TimeDelay.runFlag = !1, dialRef.timerRunning = !1, dialRef.g_timeStr = dialRef.timeString(), dialRef.displayTime();
var e = topWatchRef.getNextId();
topWatchRef.addSplit({
id: e,
value: dialRef.g_timeStr
...
resetTimer: function() {
dialRef.hour = 0, dialRef.minute = 0, dialRef.second = 0, dialRef.milliSec = 0, TimeDelay.runFlag = !1, dialRef.$.timerText.setText("Elapsed: 00:00:00.000"), dialRef.$.splitText.setText("Split: 00:00:00.000"), dialRef.cleanup();
},
cleanup: function() {
dialRef.g_timeStr = "00:00:00.000", dialRef.$.timerLayer.destroyClientControls(), dialRef.$.timerLayer.destroyClientControls();
},
displayTime: function() {
dialRef.$.timerText.setText("Elapsed: " + dialRef.g_timeStr), topWatchRef.displayTime(dialRef.g_timeStr);
},
displaySplitTime: function() {
dialRef.$.splitText.setText("Split: " + dialRef.g_timeStr);
},
timeString: function() {
var e = "000" + dialRef.milliSec;
return e = e.substring(e.length - 3), dialRef.pad(dialRef.hour) + ":" + dialRef.pad(dialRef.minute) + ":" + dialRef.pad(dialRef.second) + "." + e;
},
pad: function(e) {
var t = "0" + e;
